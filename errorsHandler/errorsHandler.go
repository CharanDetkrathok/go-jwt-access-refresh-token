...
func NewSuccessStatus() error {
	return ErrorHandler{
		Code: http.StatusOK,
		Message: "กระบวนการที่ร้อขอสำเร็จ",
	}
}
...
// STATUS 400 Bad Request — client ส่ง syntax หรือ body request ไม่ถูกต้อง
func NewBadRequestError() error {
	return ErrorHandler{
		Code: http.StatusBadRequest,
		Message: "syntax หรือ body request ไม่ถูกต้อง",
	}
}
...
func NewPaymentRequiredError() error {
	return ErrorHandler{
		...
		Message: "กรุณาทำการชำระเงินในขั้นตอนถัดไป",
	}
}
...
func NewNotFoundError() error {
	return ErrorHandler{
		...
		Message: "ไม่พบหน้าเว็บไซต์ที่ร้องขอ",
	}
}
